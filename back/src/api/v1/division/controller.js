...
export const addDivision = async ({ name, address, city, factor }) => {
  try {
...
export const editDivision = async ({ id, name, address, city, factor }) => {
  try {
    const division = await editDivisionDB({ id, name, address, city, factor })
